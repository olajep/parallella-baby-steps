...
// This is the HOST side of the max_load_test.
// The program initializes the Epiphany system, load program
// to one core on the chip and read results from the mailbox
...
int main(int argc, char *argv[])
{
	...
	e_alloc(&emem, _BufOffset, buff_sz);	
	...
	e_load_group("e_max_load_test.elf", &dev, 0, 0, platform.rows, platform.cols, E_FALSE);
