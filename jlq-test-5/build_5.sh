...
# echo "E_LIBS="${E_LIBS}
e-ld -T ${ELDF} src/e_${PROG_NM}.o src/e_start.o -o bin/e_${PROG_NM}.elf ${E_LIBS} ${E_LIBS_2} -lc -lepiphany -lgcc -lg -le-lib --strip-debug

# e-gcc -T ${ELDF} src/e_${PROG_NM}.c -o bin/e_${PROG_NM}.elf -le-lib 
e-objdump -D bin/e_${PROG_NM}.elf > code5.s
